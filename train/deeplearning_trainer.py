...
class PatternModelTrainer:
    ...
    def _encode_patterns(self, patterns: List[str], selected_patterns: List[str]) -> np.ndarray:
    ...
    def _train_test_split(self, X: np.ndarray, y: np.ndarray) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
